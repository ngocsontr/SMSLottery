...
class LodeUtil @Inject constructor(
    ...
    companion object {
        val MA_LENH = listOf(
                ...
                listOf("dàn đề chẵn chẵn", "chan chan", "00 22 44 66 88 02 20 04 40 06 60 08 80 24 42 26 62 28 82 46 64 48 84 68 86"),
                listOf("dàn đề lẻ lẻ", "le le", "11 33 55 77 99 13 31 15 51 17 71 19 91 35 53 37 73 39 93 57 75 59 95 79 97"),
                listOf("dàn đề chẵn lẻ", "chan le", "01 03 05 07 09 21 23 25 27 29 41 43 45 47 49 61 63 65 67 69 81 83 85 87 89"),
                listOf("dàn đề lẻ chẵn", "le chan", "10 12 14 16 18 30 32 34 36 38 50 52 54 56 58 70 72 74 76 78 90 92 94 96 98"),
